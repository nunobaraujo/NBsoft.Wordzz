...
namespace NBsoft.Wordzz.Core.Encryption
{
    /// <summary>
    ...
    public static class RijndaelSimple
    {
        ...
        {
            return Encrypt(plainText, encryptionKey, salt, "SHA1", 1, IV, 128);
        }

        public static string SHA1Decrypt(string encryptedText, string encryptionKey, string salt, string IV)
        {
            return Decrypt(encryptedText, encryptionKey, salt, "SHA1", 1, IV, 128);
        }
    }
}
